...
import { getKanbans, deleteKanbanById } from 'apiSdk/kanbans';
...
function KanbanListPage() {
  ...
  const handleView = (id: string) => {
    if (hasAccess('kanban', AccessOperationEnum.READ, AccessServiceEnum.PROJECT)) {
      router.push(`/kanbans/view/${id}`);
    }
  };
    ...
    <AppLayout>
      <Box bg="white" p={4} rounded="md" shadow="md">
        <Flex justifyContent="space-between" mb={4}>
          ...
          {hasAccess('kanban', AccessOperationEnum.CREATE, AccessServiceEnum.PROJECT) && (
            <NextLink href={`/kanbans/create`} passHref legacyBehavior>
                  ...
                  <Tr cursor="pointer" onClick={() => handleView(record.id)} key={record.id}>
                    ...
                    <Td>
                      {hasAccess('kanban', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                        <NextLink href={`/kanbans/edit/${record.id}`} passHref legacyBehavior>
                          <Button

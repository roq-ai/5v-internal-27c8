...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['admin', 'recruiter', 'hiring-manager', 'interviewer'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Kanban', path: '/kanbans', entity: 'kanban', service: AccessServiceEnum.PROJECT, icon: FiColumns },
    { name: 'Score', path: '/scores', entity: 'score', service: AccessServiceEnum.PROJECT, icon: FiStar },
